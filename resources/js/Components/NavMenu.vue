...
<template>
    <!-- <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 bg-blue-200 py-4"></div> -->
    <div class="max-w-xs bg-blue-200 min-h-screen shadow-2xl">
        <div class="flex justify-items-center">
            <div class="flex">
                <div class="shrink-0 flex items-center">
                    <Link :href="route('dashboard')">
                        <ApplicationLogo
                            class="block h-auto w-auto fill-current text-gray-800"
                        />
                    </Link>
                </div>
                    ...
                    <Dropdown align="right" width="48">
                        <template #trigger>
                            <span class="inline-flex rounded-md">
                                <button
                                    type="button"
                                    class="inline-flex items-end px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition ease-in-out duration-150"
                                >
